...
public final class LogsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest,
      com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse> getExportMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Export",
      requestType = com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest.class,
      responseType = com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest,
      com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse> getExportMethod() {
    io.grpc.MethodDescriptor<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest, com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse> getExportMethod;
      ...
      synchronized (LogsServiceGrpc.class) {
        if ((getExportMethod = LogsServiceGrpc.getExportMethod) == null) {
          LogsServiceGrpc.getExportMethod = getExportMethod =
              io.grpc.MethodDescriptor.<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest, com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Export"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse.getDefaultInstance()))
  ...
  public static abstract class LogsServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void export(com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest request,
        io.grpc.stub.StreamObserver<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest,
                com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse>(
  ...
  public static final class LogsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LogsServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse export(com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest request) {
  ...
  public static final class LogsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LogsServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse> export(
        com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXPORT:
          serviceImpl.export((com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest) request,
              (io.grpc.stub.StreamObserver<com.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LogsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.opentelemetry.proto.collector.logs.v1.LogsServiceProto.getDescriptor();
    }
