...
public interface ExportTraceServiceRequestOrBuilder extends
   ...
   */
  java.util.List<com.opentelemetry.proto.trace.v1.ResourceSpans> 
   ...
   * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1 [json_name = "resourceSpans"];</code>
   */
  com.opentelemetry.proto.trace.v1.ResourceSpans getResourceSpans(int index);
  /**
   * <pre>
   * An array of ResourceSpans.
   * For data coming from a single resource this array will typically contain one
   ...
   * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1 [json_name = "resourceSpans"];</code>
   */
  java.util.List<? extends com.opentelemetry.proto.trace.v1.ResourceSpansOrBuilder> 
   ...
   * <code>repeated .opentelemetry.proto.trace.v1.ResourceSpans resource_spans = 1 [json_name = "resourceSpans"];</code>
   */
  com.opentelemetry.proto.trace.v1.ResourceSpansOrBuilder getResourceSpansOrBuilder(
      int index);
}
