...
public interface LogRecordOrBuilder extends
   ...
   */
  com.opentelemetry.proto.logs.v1.SeverityNumber getSeverityNumber();
   ...
   * @return The body.
   */
  com.opentelemetry.proto.common.v1.AnyValue getBody();
  /**
   * <pre>
   * A value containing the body of the log record. Can be for example a human-readable
   * string message (including multi-line) describing the event in a free form or it can
   ...
   * <code>.opentelemetry.proto.common.v1.AnyValue body = 5 [json_name = "body"];</code>
   */
  com.opentelemetry.proto.common.v1.AnyValueOrBuilder getBodyOrBuilder();
