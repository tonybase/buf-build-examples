...
public interface SummaryDataPointOrBuilder extends
   ...
   */
  java.util.List<com.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6 [json_name = "quantileValues"];</code>
   */
  com.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile getQuantileValues(int index);
  /**
   * <pre>
   * (Optional) list of values at different quantiles of the distribution calculated
   * from the current snapshot. The quantiles must be strictly increasing.
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6 [json_name = "quantileValues"];</code>
   */
  java.util.List<? extends com.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantileOrBuilder> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6 [json_name = "quantileValues"];</code>
   */
  com.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantileOrBuilder getQuantileValuesOrBuilder(
      int index);
